...
import { ThemeTab, UpdateTab } from "./SettingsTabs";
      ...
      <Dialog as="div" className="relative z-50" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex h-4/5 items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full h-5/6 max-w-lg transform overflow-auto mt-48 rounded-2xl bg-white dark:bg-zinc-800 py-6 px-2 text-left align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
