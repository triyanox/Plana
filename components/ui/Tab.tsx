  ...
  return (
    <AnimatePresence exitBeforeEnter>
      <motion.button
        ...
        className="flex  outline-none  transition-all duration-700 hover:bg-zinc-200 hover:dark:bg-zinc-700 text-black dark:text-white justify-between px-4 items-center w-full py-2 rounded-xl "
      >
